...
$catalogue = new MessageCatalogue('en', array (
  ...
  'messages' => 
  array (
    'site.titulo.index' => 'Vostr&egrave; - Softwares and Advice',
    'site.titulo.servicos' => 'Vostr&egrave; - Softwares and Advice | Services',
    'site.titulo.portfolio' => 'Vostr&egrave; - Softwares and Advice | Portfolio',
    'site.titulo.contato' => 'Vostr&egrave; - Softwares and Advice | Contact',
    'site.titulo.sobre' => 'Vostr&egrave; - Softwares and Advice | About',
    'menu.servicos' => 'Services',
    'menu.portfolio' => 'Portfolio',
    'menu.contato' => 'Contact',
    'menu.sobre' => 'About',
    'interna.titulo.servicos' => 'Services',
    'interna.titulo.portfolio' => 'Portfolio',
    'interna.titulo.contato' => 'Contact',
    'interna.titulo.sobre' => 'About',
    'interna.subtitulo.servicos' => 'See our fields of work!',
    'interna.subtitulo.portfolio' => 'See what we\'ve done and what we are doing!',
    'interna.subtitulo.contato' => 'Send us a message! We can\'t wait for it!',
    'interna.subtitulo.sobre' => 'Discover Vostr&egrave;!',
    'servicos.sistemas.web' => 'Web Systems',
    'servicos.sistemas.desktop' => 'Softwares',
    'servicos.sites' => 'Websites',
    'servicos.consultoria' => 'Advice',
    'servicos.integracao' => 'Social Media Integration',
    'servicos.layouts' => 'Layouts',
    'portfolio.titulo.circular' => 'Vostr&egrave; Circular',
    'portfolio.descricao.resumida.circular' => 'This project aims to improve the access to information about buses routes and schedules.',
    'portfolio.descricao.completa.circular' => 'Have you ever needed to take a bus to somewhere, but you had no idea about it\'s route? Or have you ever found a bus stop, but had no idea if the bus you needed to take was passing by?</p><br /><p>This is Circular\'s goal, our newest project, which will debut in a few months! Don\'t worry about it anymore.</p><p>Information wherever you are.</p><br /><p>Are you interested? Send us a message! We\'re looking for partnership!',
    'portfolio.detalhes' => 'Details',
    'portfolio.recursos.dados' => 'Bus stop data (routes, schedules, landmark)',
    'portfolio.recursos.informacoes' => 'Information about buses and companies',
    'portfolio.recursos.codigo' => 'No QR Codes or any other symbol needed',
    'portfolio.site.desenvolvimento' => 'Under development',
    'contato.form.nome' => 'Name',
    'contato.form.email' => 'Email',
    'contato.form.titulo' => 'Subject',
    'contato.form.mensagem' => 'Message',
    'contato.email' => 'You can also send an email to',
    'contato.telefone' => 'or call',
    'sobre.nome.titulo' => 'The Name',
    'sobre.nome.descricao' => 'Vostr&egrave; is in Barra do Pira&iacute;, Rio de Janeiro, a city known as "The Valley Pearl".</p> <p>The startup name came from the pearl generator, the oyster&colon; "Vostre".</p><p>Vostr&egrave; means "You" in Catalan.',
    'sobre.idealizador.titulo' => 'The Founder',
    'sobre.idealizador.descricao' => 'Almir J&uacute;nior is graduated as a Systems Analist at Funda&ccedil;&atilde;o D. Andr&eacute; Arcoverde, in Valen&ccedil;a, Rio de Janeiro.',
    'forms.contato.submit' => 'Send',
    'rodape.legal' => 'All Rights Reserved',
  ),
  'FOSUserBundle' => 
  array (
